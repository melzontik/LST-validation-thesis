...
output_path = os.path.join(path, 'Landsat_Milan_RLM_tile_32_alpha_1') #tile is the AOI (1 of 5 zone)
...
df_super = reading_file(os.path.join(path, "super_resolved", #FOR full dataset "City_united"
                                     f'Landsat_super_resolved_{date_str}_tile_32.csv')) #for one cell 'Landsat_...._tile_N'
df_orig = reading_file(os.path.join(path, "original",        
                                    f'Landsat_original_{date_str}_tile_32.csv'))
